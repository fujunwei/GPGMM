...
namespace gpgmm { namespace d3d12 {
    ...
    // DebugResourceAllocator reports live allocations (ie. created allocations, not yet
    // deallocated) by maintaining a cache of allocations which will grow or shrink upon
    // AddLiveAllocation and DeallocateMemory, respectively.
