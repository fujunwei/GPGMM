...
namespace gpgmm { namespace d3d12 {
    ...
    void DebugResourceAllocator::ReportLiveAllocations() const {
        for (const auto& allocationEntry : mLiveAllocations) {
    ...
    void DebugResourceAllocator::AddLiveAllocation(ResourceAllocation* allocation) {
        ...
        mLiveAllocations.GetOrCreate(
            ResourceAllocationEntry(allocation, allocation->GetAllocator()), /*keepAlive*/ true);
    ...
    void DebugResourceAllocator::DeallocateMemory(MemoryAllocation* allocation) {
        ...
        auto entry = mLiveAllocations.GetOrCreate(ResourceAllocationEntry(ToBackend(allocation)),
                                                  /*keepAlive*/ false);
